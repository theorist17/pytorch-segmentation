...
class BDD100KDataset(Dataset):
    ...
    def __init__(self, base_dir='../data/bdd100k', split='train',
        ...
        self.lbl_paths = sorted(self.base_dir.glob(f'drivable_maps/labels/{self.split}/*drivable_id.png'))
...
if __name__ == '__main__':
    ...
    dataset = BDD100KDataset(split='train', net_type='deeplab', ignore_index=3, debug=True,affine_augmenter=affine_augmenter, image_augmenter=image_augmenter, target_size=(1280, 1280))
